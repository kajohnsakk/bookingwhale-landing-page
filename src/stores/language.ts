...
export const translations = {
  en: {
    ...
    supportDetailFree: "- Email support\n- Response within 24 hours\n- Available during business hours",
    supportDetailPro: "- 24/7 availability\n- Response within 4 hours\n- Email, chat & phone channels\n- Priority queue routing",
    supportDetailEnterpriseDedicated: "- Dedicated account manager\n- Monthly performance reviews\n- Proactive optimization recommendations",
    supportDetailEnterpriseSLA: "- 99.99% uptime guarantee\n- Response within 1 hour\n- Personalized onboarding program",
  },
  th: {
    // Navigation
    services: "บริการหลัก",
